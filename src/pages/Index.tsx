    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="flex justify-between items-center p-6 backdrop-blur-sm border-b border-border">
          <img src="/lovable-uploads/8c03dabd-dd83-453a-9034-8a2363b6e7de.png" alt="Floest" className="h-8 w-auto filter dark:invert dark:brightness-0 dark:saturate-100 dark:hue-rotate-90 transition-all duration-300" />
